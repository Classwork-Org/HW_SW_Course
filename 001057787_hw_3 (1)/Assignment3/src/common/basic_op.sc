...
// functions to 'cleanly' access the Overflow and Carry flags
// (only used in g_pitch.sc)
...
// void set_overflow(void)   // never used in vocoder
// {
//   Overflow = 1;
// }
...
// void set_carry(void)   // never used in vocoder
// {
//   Carry = 1;
// }
...
// Flag carry(void)   // never used in vocoder
// {
//   return(Carry);
// }
...
Word16 saturate (Word32 L_var1)
{
    ...
    else if (L_var1 < (Word32) 0xffff8000uL)
    {
        Overflow = 1;
        var_out = MIN_16;
    }
...
Word16 mult_r (Word16 var1, Word16 var2)
{
    ...
    L_product_arr += (Word32) 0x00004000uL;      /* round */
