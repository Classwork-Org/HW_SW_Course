         ...
         float tlow, float thigh, unsigned char **edge, char *fname)
{
   ...
   ****************************************************************************/
   ...
   if(write_pgm_image("./analysis/gauss", (unsigned char *)smoothedim, rows, cols, "", 255) == 0){
      fprintf(stderr, "Error writing the edge image, %s.\n", "./analysis/gauss");
      exit(1);
   }
   ...
   ****************************************************************************/
   ...
   if(write_pgm_image("./analysis/delta x", (unsigned char *)delta_x, rows, cols, "", 255) == 0){
      fprintf(stderr, "Error writing the edge image, %s.\n", "./analysis/delta x");
      exit(1);
   }

   if(write_pgm_image("./analysis/delta y", (unsigned char *)delta_y, rows, cols, "", 255) == 0){
      fprintf(stderr, "Error writing the edge image, %s.\n", "./analysis/delta y");
      exit(1);
   }
   ...
   ****************************************************************************/
   ...
   if(write_pgm_image("./analysis/magnitude", (unsigned char*) magnitude, rows, cols, "", 255) == 0){
      fprintf(stderr, "Error writing the edge image, %s.\n", "./analysis/magnitude");
      exit(1);
   }
   ...
   ****************************************************************************/
   ...
   if(write_pgm_image("./analysis/nms", nms, rows, cols, "", 255) == 0){
      fprintf(stderr, "Error writing the edge image, %s.\n", "./analysis/nms");
      exit(1);
   }
    ...
    unsigned char *result) 
{
   ...
   ****************************************************************************/
    ...
    for(count=0,resultptr=result,resultrowptr=result+ncols-1;
        count<nrows; count++,resultptr+=ncols,resultrowptr+=ncols){ // unfortunate array access
